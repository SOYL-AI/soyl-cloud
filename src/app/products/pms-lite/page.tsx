...
export default function PmsLitePage() {
  return (
    <div className="flex flex-col">
      <ProductSchema
        name="PMS Lite"
        description="A streamlined property management system for independent hotels and boutiques."
        category="SoftwareApplication"
      />
      <FAQSchema
        faqs={[
          { question: "What is PMS Lite?", answer: "PMS Lite is a streamlined property management system." }
        ]}
      />
      ...
      <section className="relative pt-32 pb-20">
        ...
        <Container className="text-center">
          ...
          >
            ...
            >
              <BrowserMockup src="/images/products_pics/New PMS pic 1.png" alt="SOYL AI PMS Dashboard" className="shadow-2xl shadow-blue-900/20" glow={true} float={false} />
            </motion.div>
          </motion.div>
        </Container>
      </section>
      ...
      <div id="features">
        <FeatureShowcase
          ...
          imageSrc="/images/products_pics/New PMS pic 2.png"
        ...
        <FeatureShowcase
          ...
          imageSrc="/images/products_pics/New PMS pic 3.png"
        ...
        <FeatureShowcase
          ...
          imageSrc="/images/products_pics/New PMS pic 4.png"
      ...
      <section className="py-24 bg-[var(--color-soyl-gray-50)] border-t border-gray-100">
        <Container>
          <SectionHeader
            ...
            description="The core capabilities of PMS Lite."
            align="left"
          />
          <SummaryBlock
            entityName="PMS Lite"
            category="Property Management System"
            coreFunction="centralizes reservations, inventory, and billing"
            benefits="independent hotels reduce administrative overhead and prevent double bookings"
          />
          <FactTable
            headers={["Feature", "Description"]}
            rows={[
              ["Deployment", "Cloud-based SaaS"],
              ["Channel Manager", "Integrates with OTA (Booking.com, Expedia)"],
              ["Analytics", "RevPAR, ADR, Occupancy tracking"],
            ]}
          />
        </Container>
      </section>
